all_achievements = {
    ...
    {code = "credit1", name = "\^t\^wdon't finish//the credits.", description =":(", tip = "quit the credits//before the end." },
    {code = "credit2", name = "\^t\^wfinish the//credits", description = ":)", tip = "look at the credits//until the end."},
