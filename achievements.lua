all_achievements = {
    ...
    {code = "credit1", name = "\^t\^wdisrespect", description ="i'm disappointed in you", tip = "quit the credits//before the end." },
    {code = "credit2", name = "\^t\^wrespect", description = "as you can see, we are very skilled", tip = "look at the credits//until the end."},
    {code = "test4", name = "\^t\^wconnected", description ="stay up to date", tip = "enable day 1 patch mode."},
    {code = "test6", name ="\^t\^wsad noises", description ="you just made our sound designer sad", tip = "disable the musics."},
    {code = "test7", name ="\^t\^wthe end is//\^t\^wnever the end", description = "wow, you did it!", tip ="launch the game."},
    {code = "test8", name ="\^t\^wkick the bucket", description ="are you proud of yourself?", tip = "it's literal, try the boot mode." },
    ...
    {code = "birthday_today", name ="\^t\^wyou're born today?!", description = "you look suspiciously old for your age.", tip = "check the year."},
